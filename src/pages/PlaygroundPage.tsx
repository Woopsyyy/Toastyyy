  ...
  useEffect(() => {
    if (location.state?.preset) {
      ...
      setConfig({
        ...
        titleDescriptionSimultaneous: preset.titleDescriptionSimultaneous ?? false
      });
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 select-none">
        <div className="max-w-xl">
          ...
          >
            ...
            <span className="text-[10px] font-extrabold text-accent-2 uppercase tracking-widest">Tactile Playground</span>
          </motion.div>
          ...
          >
            Notification <span className="gradient-text-warm font-black">Sandbox</span>
          </motion.h1>
          ...
          >
            Tweak custom spring parameters, accent boundaries, mascot moods, and behavior rules. Adjust variables on the left and see code outputs generated instantly.
          </motion.p>
        </div>
      </div>
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-white border border-border-strong rounded-[28px] shadow-xl p-6 space-y-6">
            <div className="flex justify-center py-4 bg-surface-2 rounded-2xl border border-border-strong/50 select-none">
              <ToastMascot size={120} mood={getMascotMood()} interactive={true} />
            </div>
          ...
          <div className="bg-white border border-border-strong rounded-[28px] shadow-xl overflow-hidden flex flex-col h-[calc(100vh-160px)] min-h-[500px]">
            <div className="px-6 py-4 border-b border-border-strong flex items-center justify-between bg-surface-2 select-none">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-sm font-extrabold text-text uppercase tracking-wider">Live Code Exporter</span>
              </div>
