...
function ToastStack({ position, toasts, onClose }: ToastStackProps) {
  ...
  else if (position === 'top-right') positionClasses = 'top-24 right-6 flex-col'
  else if (position === 'bottom-left') positionClasses = 'bottom-6 left-6 flex-col-reverse'
  else if (position === 'bottom-center') positionClasses = 'bottom-6 left-1/2 -translate-x-1/2 items-center flex-col-reverse'
